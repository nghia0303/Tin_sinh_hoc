...
The experiments are conducted on antibiotic-specific datasets prepared from the same shared genotype-phenotype cohort. The same cohort selection rules, phenotype cleaning rules, and genotype normalization rules are applied across all scopes to keep the comparison fair. The final experiment set contains 14 antibiotics that satisfy the minimum sample and class-count thresholds required for stable supervised learning.
